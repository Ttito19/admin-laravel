<!-- Modal -->
  <div class="modal fade" id="createbrands" tabindex="-1" aria-labelledby="createbrand-form" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="createbrand-form">Agregar Marcas</h5>
        ...
        <div class="modal-body">
            ...
            <form   id="addFormBrand" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">

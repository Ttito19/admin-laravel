<!-- Modal -->
<div class="modal fade" id="editBrands" tabindex="-1" aria-labelledby="editbrand-form"  aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="editbrand-form">Editar Marca</h5>
        ...
        <div class="modal-body">
            ...
            <form  method="POST" autocomplete="off"  id="edit-form-brand" enctype="multipart/form-data">
